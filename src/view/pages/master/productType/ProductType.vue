<template>
  <section>
    <v-card class="rounded-lg">
      <v-card-text class="py-8 px-6" style="color: #3f4254">
        <div class="d-flex align-center">
          <h1 class="text-title">Master Product Type</h1>
          <div class="ml-auto">
            <export-excel
              ...
              :name="`Export-ProductType-${new Date()
                .toISOString()
                .substr(0, 10)}.xls`"
            >
    ...
    <v-dialog v-model="addTypeMachine" width="650">
      <v-card>
        <v-card-title>
          {{ !!selectedType ? "Edit" : "Create" }} Product Type
...
import ProductTypeForm from "@/view/components/productType/ProductTypeForm.vue";
import {
  DELETE_PRODUCT_TYPE,
  FETCH_PRODUCT_TYPES,
