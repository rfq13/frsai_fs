...
<style>
.aside-minimize .menus {
  display: none !important;
}
.aside-minimize .headTitle {
  display: none !important;
}
.aside-minimize .aside-menu-wrapper {
  background: #2ffcd3 !important;
}
.brand {
  background-color: #2ffcd3 !important;
}
.aside-minimize .brand {
  background-color: #59ffde !important;
}
</style>
